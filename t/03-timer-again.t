...

{
    ...
    is(0, $repeat_1->repeat(), 'repeat_1 has the right repeat');

    # Actually make repeat_1 repeating
    $repeat_1->repeat(50);
    is(50, $repeat_1->repeat(), 'got the right repeat value');
    ...
    is(100, $repeat_2->repeat(), 'Got the right repeat value for repeat_2');
